...
6. In the Setup Dialog use the following values
    - *URL*: The root url / IP of your Improved Beszel API instance, like http://beszel.example.com or https://beszel.example.com
...
Currently all machines are added, selection will be added later (you can change this yourself by creating a new user in Improved Beszel API's PocketBase and adding this user only to the machines you want to be monitored).
